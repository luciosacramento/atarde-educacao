<?php
/**
 * Template Name: Página interna Galeria de vídeos
 *
 * Description: Template criado para exibir Galeria de vídeos
 *
 * @package WordPress
 * @subpackage atarde
    ...
    <div class="container">
      <div class="row mt-4" id="noticias-container">
        ...
        <?php
                ...
                $args = array(
                    'post_type'      => 'galeria_videos',      // Tipo de conteúdo 'post' (padrão para notícias)
                ...
                if ($query->have_posts()) {
                    ...
                    while ($query->have_posts()) {
                        ...
                        $link = get_post_meta(get_the_ID(), '_link_video', true);
      ...
      <button id="mais-noticias" data-paged="1" tipo="galeria_videos">Carregar mais</button>
      <script>
