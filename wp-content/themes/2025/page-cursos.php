                    ...
                    <div class="col-md-3 p-3">
                        <div class="video-card">
                            ...
                            if (!empty($video_url)) { ?>
                                ...
                                <a href="#" class="abrir-modal" data-url="<?php echo $video_url; ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="details">
                                    <p><i
                                            class="bi bi-clock"></i><?php echo get_post_meta(get_the_ID(), '_curso_duracao', true) ?>
                                    </p>
                                    ...
                                    <p><i
                                            class="bi bi-bar-chart"></i><?php echo get_post_meta(get_the_ID(), '_curso_nivel', true) ?>
                                    </p>
                                </div>
                                <p class="description">
