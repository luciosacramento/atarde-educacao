            ...
            if (!empty($imagens)) {
                ...
                foreach ($imagens as $imagem_id) {
                    ...
                    <div class="col-md-4 p-3">
                        <div class="card">
                            <a href="#" class="abrir-modal" data-url="<?php echo esc_url($imagem_destaque_full); ?>"
                                data-title="<?php echo $title; ?>" data-content="<?php echo get_the_content(); ?>">
                                <img src="<?php echo esc_url($imagem_destaque); ?>" class="card-img-top"
                                    alt="<?php echo $title; ?>">
                            </a>
                            <div class="card-body">
