...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>?<?php echo strtotime(date('Y-m-d h:i:s')); ?>"
    type="text/css" media="screen" id="color-style" />
...
<![endif]-->
  ...
  <header class=" text-white">
    <div class="container cont-nav-heade">
      <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        ?>
        <?php if ($is_singular && $slug != "home") { ?> <a class="navbar-brand" href="<?php echo $page_link; ?>">A Tarde
            Educação</a><?php } ?>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <?php get_search_form(); ?>
          <div class="d-flex">
            <?php if ($ava = get_option('atarde_ava_link')): ?>
              <div class="p-2">
                <a href="<?php echo esc_url($ava); ?>" target="_blank" rel="noopener">
                  <img src="<?php bloginfo('template_url'); ?>/img/icon-ava.png" alt="AVA">
                </a>
              </div>
            <?php endif; ?>
            ...
            <?php if ($instagram = get_option('atarde_instagram_link')): ?>
              <div class="p-2">
                <a href="<?php echo esc_url($instagram); ?>" target="_blank" rel="noopener">
                  <img src="<?php bloginfo('template_url'); ?>/img/icon-insta.png" alt="Instagram">
                </a>
              </div>
            <?php endif; ?>
            ...
            <?php if ($facebook = get_option('atarde_facebook_link')): ?>
              <div class="p-2">
                <a href="<?php echo esc_url($facebook); ?>" target="_blank" rel="noopener">
                  <img src="<?php bloginfo('template_url'); ?>/img/icon_face.png" alt="Facebook">
                </a>
              </div>
            <?php endif; ?>
            ...
            <?php if ($youtube = get_option('atarde_youtube_link')): ?>
              <div class="p-2">
                <a href="<?php echo esc_url($youtube); ?>" target="_blank" rel="noopener">
                  <img src="<?php bloginfo('template_url'); ?>/img/icon-youtube.png" alt="YouTube">
                </a>
              </div>
            <?php endif; ?>
          </div>
  ...
  if ($is_singular && $slug != "home") { ?>
      ...
      <div class="row align-items-center">
        <div class="col-md-12 cont-imagem no-padding-lr">
          ...
          if (isset($_GET["s"])) {
            ...
            if ($is_singular && $post_type == 'noticias_post') {
    ...
    if ($is_singular && $post_type == 'area-atuacao-post') {
