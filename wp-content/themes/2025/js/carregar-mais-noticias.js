jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '.abrir-modal', function (e) {
        e.preventDefault(); // Previne o scroll para o topo
        ...
        // Encontra o índice do item clicado baseado na URL ou título
        currentIndex = galleryImages.findIndex(function (item) {
            return item.url === clickedItem.url && item.title === clickedItem.title && item.depoimento === clickedItem.depoimento;
        });
